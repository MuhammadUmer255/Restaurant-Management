      ...
      <Modal visible={modalVisible} animationType="slide" transparent>
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            <TextInput style={styles.input} value={name} onChangeText={setName} placeholder="e.g. John Doe" placeholderTextColor="#666" />

            <Text style={styles.label}>Work Email</Text>
            <TextInput style={styles.input} value={email} onChangeText={setEmail} keyboardType="email-address" placeholder="email@gourmet.com" placeholderTextColor="#666" />

            <Text style={styles.label}>Role</Text>
            <View style={styles.rolePickerRow}>
              {['Head Waiter', 'Head Chef', 'Manager'].map(r => (
                <TouchableOpacity
                  key={r}
            ...
            <View style={styles.switchRow}>
              ...
              <Switch value={active} onValueChange={setActive} thumbColor={active ? '#FF6B00' : '#f4f3f4'} />
            </View>
...
const styles = StyleSheet.create({
  ...
  empRole: { color: '#FF6B00', fontSize: 12, marginVertical: 2 },
  ...
  roleChip: { backgroundColor: '#0B101D', padding: 8, borderRadius: 6, marginRight: 6, marginBottom: 6 },
  activeRoleChip: { backgroundColor: '#FF6B00' },
