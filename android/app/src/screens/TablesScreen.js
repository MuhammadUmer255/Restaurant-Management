...
const INITIAL_TABLES = [
  ...
  { id: 'T-02', seats: 4, status: 'Occupied', customer: 'Julien', amount: '$148.50', zone: 'Indoor Main', order: [{ name: 'Truffle Wagyu Ribeye', price: '$68.00' }, { name: 'Yuzu Basil Smash', price: '$28.00' }] },
  { id: 'T-03', seats: 6, status: 'Reserved', customer: 'Dr. Raymond', time: '19:30', zone: 'Terrace' },
  { id: 'T-04', seats: 2, status: 'Occupied', customer: 'Sarah', amount: '$95.00', zone: 'Indoor Main', order: [{ name: 'Hokkaido Scallops Crudo', price: '$39.25' }] },
  { id: 'T-05', seats: 4, status: 'Available', zone: 'Terrace' },
  { id: 'VIP-1', seats: 8, status: 'Occupied', customer: 'VIP Guest', amount: '$390.00', zone: 'Terrace', order: [{ name: 'Chef Special Platter', price: '$390.00' }] },
];
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        <View>
          ...
          <Text style={styles.location}>Restaurant Floor • {selectedTable}</Text>
        </View>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
        ...
        <View style={styles.statsRow}>
          ...
          <View style={styles.statCard}>
            ...
            <Text style={styles.redValue}>{occupied}</Text>
        ...
        <View style={styles.grid}>
          {filteredTables.map(table => (
            ...
            >
              ...
              {table.customer && (
                <Text style={styles.customer}>{table.customer}</Text>
              )}
              {table.amount && (
          ...
          <View style={styles.selectedPanel}>
            ...
            <View style={styles.actionRow}>
              ...
              <TouchableOpacity style={[styles.actionButton, styles.primaryButton]}>
                <Text style={styles.primaryText}>View Bill</Text>
              </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  location: { color: '#7D879D', fontSize: 12, marginTop: 5 },
  notification: { color: '#FF7622', fontSize: 25 },
  ...
  statValue: { color: '#FFFFFF', fontSize: 22, fontWeight: '800', marginTop: 6 },
  redValue: { color: '#FF526A', fontSize: 22, fontWeight: '800', marginTop: 6 },
  greenValue: { color: '#35D49B', fontSize: 22, fontWeight: '800', marginTop: 6 },
  smallText: { color: '#778197', fontSize: 11 },
  legend: { flexDirection: 'row', justifyContent: 'space-between', marginVertical: 18 },
  legendText: { color: '#9CA4B5', fontSize: 11 },
  ...
  badge: { paddingHorizontal: 7, paddingVertical: 5, borderRadius: 7 },
  seats: { color: '#858FA5', marginTop: 12 },
  customer: { color: '#D9DDE7', marginTop: 10, fontWeight: '600' },
  amount: { color: '#35D49B', marginTop: 5, fontWeight: '700' },
  time: { color: '#F5AE22', marginTop: 5, fontSize: 12 },
  selectedPanel: {
    backgroundColor: '#0D162C',
    borderRadius: 20,
    borderWidth: 1,
  ...
  selectedTitle: { color: '#FFFFFF', fontSize: 22, fontWeight: '800' },
  selectedSubtitle: { color: '#7F899F', marginTop: 5 },
  divider: { height: 1, backgroundColor: '#202D49', marginVertical: 16 },
  orderTitle: { color: '#FFFFFF', fontWeight: '700', marginBottom: 10 },
  orderItem: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 9 },
  orderName: { color: '#BFC5D3', flex: 1 },
  orderPrice: { color: '#FFFFFF', fontWeight: '700' },
  emptyNotice: { color: '#7D879D', fontStyle: 'italic', paddingVertical: 8 },
  ...
  actionText: { color: '#C8CEDA', fontWeight: '700' },
